...
<html>
    <head>
        ...
        <form action="reprovar_adocao.php" method="POST" enctype="multipart/form-data">
    ...
    <div class="conteudo">
        ...
        <div class="coluna_direita">
            <div>
                <h2> Reprovar Adoção </h2>
                <div class="login">
                    <form action="reprovar_adocao.php" method="POST" enctype="multipart/form-data">
                        <h4> CPF: <b style="color: #2A804F"> * </b> </h4>
                        <select type="text" name="cpf" id="cpf" style="width: 300px; height: 25px;">  
                            <option> Selecione o CPF do Adotante </option>
                        <?php
                            ...
                            $query = sprintf("SELECT * FROM adocao WHERE status = 0");
                    ...
                    <br> <br>
                    <input type="submit" name="reprovar" value="Reprovar" id="reprovar" style="width: 100px; height: 30px; border-radius: 7px;" class="logar">
                    <br> <br>
