...
<form action="voltar_animal.php" method= "POST">
...
<div class="conteudo">
        ...
        <div class="acesso">
            ...
            <div class="navegacao">
                <ul>
                        ...
                        <li>
                            <a id="historico_animal" href="historico_animal.php"> Histórico Animal </a>
                        </li>
                        <li>
    ...
    <div class="coluna_direita">
        <div>
                <h2> Disponibilizar Animal </h2>
                <div class="login">
                    <form method="POST" enctype="multipart/form-data" action="voltar_animal.php">
                        ...
                        <?php
                            ...
                            $query = sprintf("SELECT * FROM `animal` WHERE `status` = 0");
            ...
            <div align="center">
                <input type="submit" name="disponibilizar" value="Disponibilizar" id="disponibilizar" style="width: 100px; height: 30px; border-radius: 7px;" class="logar">
                    <br> <br>
                </div>
               </div>
</div>
