...
<html>
    <head>
        ...
        <form action="aprovar_adocao.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="coluna_direita">
            <div>
                ...
                <div class="login">
                    ...
                    <br> <br>
                    <input type="submit" name="aprovar" value="Aprovar" id="aprovar" style="width: 100px; height: 30px; border-radius: 7px;" class="logar">
                    <br> <br>
