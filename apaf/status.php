<html>
    ...
    <form action="status_adocao.php" method="POST" enctype="multipart/form-data"/>
        ...
        <div class="coluna_direita">
            <div>
                ...
                <div class="login">
                    <form action="status_adocao.php" method="POST" enctype="multipart/form-data">
                        <br>
                        <h4> Adotante: <b style="color: #2A804F"> * </b> </h4>
                        <select type="text" name="nome" id="nome" style="width: 300px; height: 25px;">  
                            <option> Selecione um adotante </option>
                        ...
                        <?php
                            ...
                            $query = sprintf("SELECT * FROM adocao WHERE status = 1");
                        ...
                        <br> <br>
                        <input type="submit" name="alterar" value="Alterar" id="alterar" style="width: 100px; height: 30px; border-radius: 7px;" class="logar">
                        <br> <br>
                    </form>
                </div>
            </div>
