    ...
    <div class="conteudo">
        ...
        <div class="coluna_direita">
            <div>
                ...
                <div class="login">
                    <form action="atualizar_evento.php" method="POST" enctype="multipart/form-data">
                        <h4> Nome do Evento: <b style="color: #2A804F"> * </b> </h4>
                        <select type="text" name="evento" id="evento" style="width: 300px; height: 25px;">  
                        ...
                        <h4> Evento: <b style="color: #2A804F"> * </b> </h4>
                        <input type="text" placeholder="Novo nome do evento" name="evento_atualizado" id="evento_atualizado" style="width: 300px; height: 25px;">
                        <br>

                        <h4> Descrição: </h4>
                        <input type="text" placeholder="Nova descrição do evento" name="descricao" id="descricao" style="width: 300px; height: 50px;">
                        <br>
                    ...
                    <br> <br>
                    <input type="submit" name="salvar" value="Atualizar" id="atualizar" style="width: 100px; height: 30px; border-radius: 7px;" class="logar">
                    <br> <br>
                </div>
            </div>
        </div>
