...
<form action="exibir_evento.php" method= "POST">
...
<div class="conteudo">
        ...
        <div class="acesso">
            ...
            <div class="navegacao">
                <ul>
                        ...
                        <li>
                            <a id="historico_animal" href="../animal/historico_animal.php"> Histórico Animal </a>
                        </li>
                        <li>
    ...
    <div class="coluna_direita">
        <div>
                <h2> Exibir Evento </h2>
                <div class="login">
                    <form method="POST" enctype="multipart/form-data" action="exibir_evento.php">
                        ...
                        <?php
                            ...
                            $query = sprintf("SELECT * FROM evento WHERE status = 0");
            ...
            <div align="center">
                <input type="submit" name="exibir" value="Exibir" id="exibir" style="width: 100px; height: 30px; border-radius: 7px;" class="logar">
                    <br> <br>
                </div>
               </div>
</div>
